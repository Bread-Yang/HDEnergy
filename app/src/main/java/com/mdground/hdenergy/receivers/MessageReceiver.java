package com.mdground.hdenergy.receivers;
...
public class MessageReceiver extends XGPushBaseReceiver {
	...
	// 通知展示
	@Override
	public void onNotifactionShowedResult(final Context context, XGPushShowedResult notifiShowedRlt) {
		if (context == null || notifiShowedRlt == null) {
			return;
		}

		KLog.e("onNotifactionShowedResult,收到推送!!!");
